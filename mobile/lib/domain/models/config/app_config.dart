...
class AppConfig {
  ...
  T read<T>(SettingsKey<T> key) =>
      (switch (key) {
            ...
            .backupParallelUploads => backup.parallelUploads,
            .backupSortSmallestFirst => backup.sortSmallestFirst,
            .backupReserveSlotForPhotos => backup.reserveSlotForPhotos,
  ...
  AppConfig write<T, U extends T>(SettingsKey<T> key, U value) {
    return switch (key) {
      ...
      .backupParallelUploads => copyWith(backup: backup.copyWith(parallelUploads: value as int)),
      .backupSortSmallestFirst => copyWith(backup: backup.copyWith(sortSmallestFirst: value as bool)),
      .backupReserveSlotForPhotos => copyWith(backup: backup.copyWith(reserveSlotForPhotos: value as bool)),
