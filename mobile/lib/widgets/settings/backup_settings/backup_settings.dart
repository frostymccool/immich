...
class _SortSmallestFirstButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _BackupSwitchTile(
      ...
      title: "Upload smallest files first",
      subtitle: "Uploads are sorted by file size so smaller files complete first",
    );
  }
}
...
class _ReservePhotoSlotButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _BackupSwitchTile(
      ...
      title: "Reserve slot for photos",
      subtitle: "When uploading in parallel, always keep 1 slot available for photos",
    );
  }
}
