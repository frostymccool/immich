                  ...
                  children: [
                    ...
                    Text(
                      isFailed
                          ...
                          : "backup_upload_progress".t(
                              context: context,
                              args: {
                                'total': formatHumanReadableBytes(item.fileSize, 1),
                                'transferred': formatHumanReadableBytes((item.progress * item.fileSize).round(), 1),
                                'speed': item.networkSpeedAsString,
                              },
                            ),
                    ...
                    : Column(
                        ...
                        children: [
                          ...
                          if (item.timeRemainingAsString != '--:--')
                            Text(
                              "backup_upload_eta".t(context: context, args: {'time': item.timeRemainingAsString}),
                              textAlign: TextAlign.right,
